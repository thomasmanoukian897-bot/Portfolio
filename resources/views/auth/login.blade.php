...
@section('title', 'Sign In | Digital Builder')
        ...
        <div class="relative z-10 w-full max-w-md px-6">
            <div class="text-center mb-8 space-y-4">
                ...
                <p class="text-sm text-slate-600 leading-relaxed">
                    Sign in to your Digital Builder account to continue.
                </p>
            </div>
            ...
            <div class="glass-card rounded-2xl p-8 shadow-md">
                ...
                <div class="relative mb-6">
                    ...
                    <div class="relative flex justify-center text-xs uppercase">
                        <span class="bg-white px-2 text-slate-500 font-mono tracking-widest">or sign in with email</span>
                    </div>
                </div>
