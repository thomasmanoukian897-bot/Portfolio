<section class="relative min-h-[85vh] flex flex-col items-center justify-center pt-16 overflow-hidden mesh-gradient">
    ...
    <div class="relative z-10 text-center px-6 max-w-5xl mx-auto space-y-8">
        ...
        <h1 class="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tighter leading-tight text-slate-900 font-display">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <button type="button" class="w-full sm:w-auto px-10 py-4 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-sm font-bold uppercase tracking-widest flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-sm">
                Build with us
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                </svg>
            </button>
            <button type="button" class="w-full sm:w-auto px-10 py-4 glass-card hover:bg-slate-50 transition-colors rounded-xl text-sm font-bold uppercase tracking-widest text-slate-700 hover:scale-[1.02] active:scale-[0.98]">
                View Ecosystem
            </button>
        </div>
    </div>
